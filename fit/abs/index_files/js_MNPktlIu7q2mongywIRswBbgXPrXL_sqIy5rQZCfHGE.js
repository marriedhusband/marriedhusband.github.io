...
var zeusLoadMore = {
    ...
    refreshSlideshowAds: function() {
        ...
        try {
            yieldbot.setSlotTargeting("dfp-ad-"+top_leaderboard_ad, googletag.slots[top_leaderboard_ad]);
        } catch(e) {}

        try {
            yieldbot.setSlotTargeting("dfp-ad-"+right_rail_ad, googletag.slots[right_rail_ad]);
        } catch(e) {}
        
        try {
            yieldbot.setSlotTargeting("dfp-ad-"+interstitial_ad, googletag.slots[interstitial_ad]);
        } catch(e) {}
