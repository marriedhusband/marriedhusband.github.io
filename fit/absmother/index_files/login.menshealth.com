...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://login.menshealth.com";
...
if (typeof janrain.settings.width === 'undefined')janrain.settings.width = "292";
if (typeof janrain.settings.providersPerPage === 'undefined')janrain.settings.providersPerPage = "6";
if (!janrain.settings.actionText)janrain.settings.actionText = " ";
if (typeof janrain.settings.fontColor === 'undefined')janrain.settings.fontColor = "#e63e3e";
if (typeof janrain.settings.fontFamily === 'undefined')janrain.settings.fontFamily = "arial";
if (typeof janrain.settings.backgroundColor === 'undefined')janrain.settings.backgroundColor = "#030000";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "pppnnpgjmefgilnpgdjm";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://login.menshealth.com";
...
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "128455567236258";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://login.menshealth.com";
...
function getRootPath() {
    if (window.localStorage && localStorage.janrainLocalWidgetCodeEnabled === "true") {
        var rootPath = localStorage.janrainLocalWidgetCodeUrl || "http://apps.janrain.com:4567/";
...
function getPackagePath(packages) {
    ...
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('1.111.0_widgets_503');
    return path;
}
