 ...
 *
 * Added custom modification by Victor Pavlov
 * This script was modified according to flexonline.com needs
 * In method setupMarkup were removed this lines:
 * $('body > *').not(jP.menu + ', ' + jP.options.excludedPanelContent).wrapAll('<div class="' + jP.panel.replace('.','') + '"/>');
 * $(jP.options.menu).clone().attr('id', jP.menu.replace('#','')).insertAfter('body > ' + jP.panel);
 * It conflicted with dart advertisment block
 * And as we have ability to control layout manually
 * needed panel element and menu container were created at all page template
 * */
  ...
  e.jPanelMenu = function(t) {
    ...
    var n = {
      options: e.extend({
        ...
        header: "#header",
        headerClass: 'header-default-position',
        excludedPanelContent: "style, script, #top-ad",
        direction: "left",
        openPosition: "250px",
        animated: true,
      ...
      setPositionUnits: function() {
        ...
        if (!e) {
          n.options.openPosition = parseInt(n.options.openPosition) + n.settings.positionUnits
        }
      },
      checkFixedChildren: function() {
        ...
        e(n.panel).find("> *").each(function() {
          if (e(this).css("position") == "fixed" && e(this).css(n.options.direction) == "auto") {
            n.fixedChildren.push(this)
          }
        });
        if (n.fixedChildren.length > 0) {
          ...
          n.setPanelStyle(r);
          if (parseInt(e(n.fixedChildren[0]).offset().left) == 0) {
            n.settings.shiftFixedChildren = true
          }
        }
        n.setPanelStyle(t)
      },
      setjPanelMenuStyles: function() {
        var t = "#fff";
        var r = e("html").css("background-color");
        var i = e("body").css("background-color");
        if (i != "transparent" && i != "rgba(0, 0, 0, 0)") {
          t = i
        } else if (r != "transparent" && r != "rgba(0, 0, 0, 0)") {
          t = r
        } else {
          t = "#fff"
        } if (e("#jPanelMenu-style-master").length == 0) {
      ...
      menuIsOpen: function() {
        if (n.getMenuState() == "open") return true;
        else return false
      },
      ...
      enableTransitions: function(t, r) {
        var i = t / 1e3;
        var s = n.getCSSEasingFunction(r);
        n.disableTransitions();
      ...
      enableFixedTransitions: function(t, r, i, s) {
        var o = i / 1e3;
        var u = n.getCSSEasingFunction(s);
      ...
      openMenu: function(t) {
        e(n.options.header).removeClass(n.options.headerClass);
        if (typeof t == "undefined" || t == null) {
        ...
        var r = {
          none: !t ? true : false,
          transitions: t && n.settings.transitionsSupported ? true : false
        };
        if (r.transitions || r.none) {
          if (r.none) n.disableTransitions();
          if (r.transitions) n.enableTransitions(n.options.openDuration, n.options.openEasing);
          var i = {};
          i[n.options.direction] = n.options.openPosition;
          n.setPanelStyle(i);
          if (n.settings.shiftFixedChildren) {
            e(n.fixedChildren).each(function() {
              var t = e(this).prop("tagName").toLowerCase() + " " + e(this).attr("class"),
                i = t.replace(" ", "."),
                t = t.replace(" ", "-");
              if (r.none) n.disableFixedTransitions(t);
              if (r.transitions) n.enableFixedTransitions(i, t, n.options.openDuration, n.options.openEasing);
              var s = {};
      ...
      closeMenu: function(t) {
        e(n.options.header).addClass(n.options.headerClass);
        if (typeof t == "undefined" || t == null) {
          t = n.options.animated
        }
        n.clearTimeouts();
        ...
        if (r.transitions || r.none) {
          if (r.none) n.disableTransitions();
          if (r.transitions) n.enableTransitions(n.options.closeDuration, n.options.closeEasing);
          var i = {};
          ...
          if (n.settings.shiftFixedChildren) {
            e(n.fixedChildren).each(function() {
              var t = e(this).prop("tagName").toLowerCase() + " " + e(this).attr("class"),
                ...
                t = t.replace(" ", "-");
              if (r.none) n.disableFixedTransitions(t);
              if (r.transitions) n.enableFixedTransitions(i, t, n.options.closeDuration, n.options.closeEasing);
              var s = {};
      ...
      initiateContentClickListeners: function() {
        if (!n.options.closeOnContentClick) return false;
        e(document).on("click", n.panel, function(e) {
          if (n.menuIsOpen()) n.closeMenu(n.options.animated)
        });
        ...
        e(document).on("keydown", function(r) {
          ...
          for (mapping in n.options.keyboardShortcuts) {
            if (r.which == n.options.keyboardShortcuts[mapping].code) {
              ...
              if (o.open && o.close) {
                n.triggerMenu(n.options.animated)
              } else if (o.open && !o.close && !n.menuIsOpen()) {
                n.openMenu(n.options.animated)
              } else if (!o.open && o.close && n.menuIsOpen()) {
                n.closeMenu(n.options.animated)
              }
              return false
            }
          }
      ...
      init: function() {
        ...
        if (Object.prototype.toString.call(n.options.keyboardShortcuts) === "[object Array]") {
          n.initiateKeyboardListeners()
        }
